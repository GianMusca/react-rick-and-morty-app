  ...
  return (
    ...
    >
      <div className="d-flex flex-column r-m-info">
        ...
        />
        <div className="card-body d-flex flex-column gap-2 p-0 align-items-center justify-content-evenly">
          <h2 className="t-cd-r-m card-text text-wrap text-center pt-2">
            {characterInfo.name}
          </h2>
          {!moreOpen ? (
            <button
